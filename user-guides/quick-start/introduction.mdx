---
title: 'Welcome to ChatRos'
description: 'Get started with ChatRos and discover how to build intelligent agents trained on your business data.'
---
...
<div style={{
  ...
  <img
    ...
    src="/logo/light.svg"
    alt="ChatRos Hero Light"
    style={{ maxWidth: '300px', height: 'auto' }}
  />
  <img
    className="hidden dark:block"
    src="/logo/dark.svg"
    alt="ChatRos Hero Dark"
    style={{ maxWidth: '300px', height: 'auto' }}
  />
</div>
